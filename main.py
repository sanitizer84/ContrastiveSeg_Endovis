...
if __name__ == "__main__":
    ...
    parser.add_argument('--configs', default="/home/duhj/ContrastiveSeg/configs/coco_stuff/H_48_D_4.json", type=str,
    ...
    # # ***********  Params for data.  **********
    parser.add_argument('--data_dir', default="/home/duhj/datasets/coco_stuff_10k", type=str, nargs='+', dest='data:data_dir')
    ...
    parser.add_argument('--drop_last', type=str2bool, nargs='?', default=True,
    ...
    parser.add_argument('--checkpoints_name', default="hrnet_w48_2", type=str,
    ...
    # # ***********  Params for model.  **********
    parser.add_argument('--model_name', default="hrnet_w48", type=str,
    ...
    parser.add_argument('--pretrained', type=str, default="/home/duhj/ContrastiveSeg/pretrained_model/hrnetv2_w48_imagenet_pretrained.pth", dest='network:pretrained')
    ...
    parser.add_argument('--gathered', type=str2bool, nargs='?', default=False,
    ...
    parser.add_argument('--nbb_mult', default=10, type=float,
    ...
    parser.add_argument('--log_to_file', type=str2bool, nargs='?', default=False,
                        dest='logging:log_to_file', help='Whether to log into files.')
