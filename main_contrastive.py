...
if __name__ == "__main__":
    ...
    # ***********  Params for model.  **********
    parser.add_argument('--model_name', default="hrnet_w48_contrast", type=str,
    ...
    parser.add_argument('--loss_balance', type=str2bool, nargs='?', default=True,
                        dest='network:loss_balance', help='Whether to balance GPU usage. Important for multi GPU!')
    ...
    parser.add_argument('--loss_type', default="contrast_ce_loss", type=str,
                        dest='loss:loss_type')
